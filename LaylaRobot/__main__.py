...
Maintained by Katsu Team❤
"""

buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ᴀᴅᴅ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕️", url="t.me/KatsuRobot?startgroup=true"),
    ],
    [
    ...
    [
        InlineKeyboardButton(text="ʟᴏɢꜱ", url=f"https://t.me/GlobalBans"),
        InlineKeyboardButton(
            text="ꜰᴇᴅᴇʀᴀᴛɪᴏɴ", url=f"https://t.me/KatsuLogs"
        ),
    ],
    [
...
Powered by :- [Katsu](t.me/katsulogs)"""

layla_IMG = "https://telegra.ph/file/524b78577a42b02b2f074.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project [Katsu](t.me/katsuSupport) \
 Supporting isnt always financial! [Katsu](t.me/katsuSupport) \
 Those who cannot provide monetary support are welcome to help us To develop the bot  ."""
...
def layla_about_callback(update, context):
    ...
    if query.data == "layla_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Katsu*, a powerful group management bot built to help you to manage your group easily.
                 ...
                 \n\n_Katsu licensed under the GNU General Public License v3.0_
                 \n❍ Fed Logs - @KatsuLogs
                 \n❍ Support Group @katsuSupport
                 \n❍ And More Features.
                 \nGoogle [Google](https://google.com).
                 \n\nIf you have any question about Katsu, let us know .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
